// ═══════════════════════════════════════════════════════════
//  پرونده‌ی علیرضا — Tâche 3 (بیان دیدگاه)
...
const Q_KEYS = ["work", "adapt", "tv", "internet", "ecrans", "economie", "bienetre", "bonheur", "transports", "etudes"];
...
function showDashboard() {
  ...
  dash.innerHTML = `
    <div class="intro fade-in">
      سلام علیرضا 👋 این پرونده برای <b>Tâche 3</b> است: بیان دیدگاه با استدلال. این تکلیف ۴ دقیقه و ۳۰ ثانیه است و باید پیوسته و ساختارمند حرف بزنی. اول <b>الگوی استاندارد</b> و <b>ساختارهای کلیدی</b> را ببین، بعد سراغ موضوع‌ها برو. هر موضوع پنج نسخه‌ی جواب + ساختار پاراگراف‌بندی + تمرین + نکات گرامری دارد. 🎯
    </div>
